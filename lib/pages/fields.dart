...
class MapSampleState extends State<MapSample> {
  ...
  void initState(){
    ...
    fields.forEach((element) {
      http.get(Uri.parse('http://portal.robopole.ru/data/getgeobyyear/${element}?year=2022')).then((response) {
        ...
        _polygons.add(Polygon(
            ...
            onTap: () {
              Navigator.of(context).push(_createRoute(element));
            }));
      }).catchError((error){
        print("Error: $error");
      });
